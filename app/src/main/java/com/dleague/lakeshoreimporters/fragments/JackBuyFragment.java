...
public class JackBuyFragment extends Fragment implements NetworkCallbacks, ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            rootView = inflater.inflate(R.layout.fragment_jake_buy, container, false);
    ...
    private void getFirstProducts() {
        networkCalls.getFirstCollectionsById(JAKES_BUY, 20);
    }

    private void getNextProducts() {
        if (hasNextPage) {
            networkCalls.getNextCollectionsById(JAKES_BUY, 20, lastCursor);
        }
    }
