...
import static com.dleague.lakeshoreimporters.utils.Constants.PAST_BUYS;

public class BuyStatusFragment extends Fragment implements NetworkCallbacks, ItemClickListener {

    @BindView(R.id.recyclerview_past_buy)
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_buy_status,container,false);
    ...
    private void getFirstProducts() {
        networkCalls.getFirstCollectionsById(PAST_BUYS, 20);
    }

    private void getNextProducts() {
        if(hasNextPage) {
            networkCalls.getNextCollectionsById(PAST_BUYS, 20, lastCursor);
        }
    }
