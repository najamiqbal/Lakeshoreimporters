...
import static com.dleague.lakeshoreimporters.utils.Constants.CASE_BUY;
...
import static com.dleague.lakeshoreimporters.utils.Constants.JAKES_BUY;
import static com.dleague.lakeshoreimporters.utils.Constants.LOG_TAG;

/**
 * A simple {@link Fragment} subclass.
 */
public class CaseBuysFragment extends Fragment implements NetworkCallbacks, ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_case_buys, container, false);
    ...
    public void onFailure(int responseCode, ApolloException exception) {
        ...
        Log.d("GET_PRODUC TS: ", Log.getStackTraceString(exception));
    }
    ...
    private void getFirstProducts() {
        networkCalls.getFirstCollectionsById(CASE_BUY, 20);
    }

    private void getNextProducts() {
        if (hasNextPage) {
            networkCalls.getNextCollectionsById(CASE_BUY, 20, lastCursor);
        }
    }
    ...
    private void handleCallbackResponse(Response response) {
        if (Validations.isObjectNotEmptyAndNull(response)) {
            ...
            Log.i("ahsan", "extra work: : "+data.toString());
