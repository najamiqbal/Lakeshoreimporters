...
import static com.dleague.lakeshoreimporters.utils.Constants.CLOTHING_BUY;
...
public class ClothingFragment  extends Fragment implements NetworkCallbacks, ItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_clothings, container, false);
    ...
    private void getFirstProducts() {
        networkCalls.getFirstCollectionsById(CLOTHING_BUY, 20);
    }

    private void getNextProducts() {
        if (hasNextPage) {
            networkCalls.getNextCollectionsById(CLOTHING_BUY, 20, lastCursor);
        }
    }
