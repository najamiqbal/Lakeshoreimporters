...
public class MyNotificationAdapter extends RecyclerView.Adapter<MyNotificationAdapter.ViewHolder> {
    ...
    public MyNotificationAdapter(Context context, List<GetLastOrdersQuery.Edge> ordersList, ItemClickListener itemClickListener) {
    ...
    @NonNull
    @Override
    public MyNotificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_layout_my_notification, viewGroup, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull MyNotificationAdapter.ViewHolder viewHolder, int i) {
        GetLastOrdersQuery.Edge object = ordersList.get(i);
        viewHolder.tvOrderNumber.setText("Your Order no  " + String.valueOf(object.node().name())+"  has been confirmed");
